...
function rightDockClose() {
  return '<button class="panel-toggle right-dock-close" type="button" data-toggle-panel="right" aria-expanded="true" aria-label="Minimize right panel"><span class="toggle-text">Minimize</span></button>';
}
