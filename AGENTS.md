...
13. **MODEL ESTIMATE ≠ ON-CHAIN FACT.** Every fair-value probability, volatility
    ...
    render them with their provenance. Never present the fair-value engine's number as
